            ...
            onClick: function(elem, eventInfo, e) {
                ...
                //Nodes onclick throws a tooltip with compound information with structure, definition and mass based on alpha.
                    ...
                    img.onload = function (){
                        ...
                        element.innerHTML = '<b>'+'<a href="chebiOntology.do?chebiId=CHEBI:'+structure+'" class = "linkDE" text-Decoration = "none" >'+elem.name.charAt(0).toUpperCase() + elem.name.slice(1) +'</a>'+
